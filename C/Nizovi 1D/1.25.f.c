...
void broj_elemenata_niza_parni_neparni(int n,int a[n])
{
    int i,bp=0,bn=0;
    for(i=0;i<n;i++)
    {
    ...
    printf("broj clanova koji su parni je %d\n",bp);
    printf("broj clanova koji su neparni je %d\n",bn);
}
...
void main()
{
    ...
    ispis_niza(n,a);
    broj_elemenata_niza_parni_neparni(n,a);
}